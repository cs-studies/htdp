...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Exercise-464) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;;
;; Exercise 464.
...
(define soe-2 (list (list 2 2 3 10)
                    (list 0 3 9 21)
                    (list 0 -3 -8 -19)))
...
(check-expect (check-solution soe-2 S) #true)
