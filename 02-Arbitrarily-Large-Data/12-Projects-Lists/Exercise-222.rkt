...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname Exercise-222) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;;
;; Exercise 222.
;; Modify the program from exercise 221
;; so that a player can control the horizontal movement of the dropping block.
