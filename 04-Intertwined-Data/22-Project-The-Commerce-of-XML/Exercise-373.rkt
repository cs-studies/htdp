...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Exercise-373) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;;
;; Exercise 373.
;; Figure 128 is missing test cases.
;; Develop test cases for all the functions.
...
(define (render-item i)
  (local ((define content (first (xexpr-content i)))
    ...
    (bulletize
     (cond
       [(word? content)
        (text (word-text content) FONT-SIZE FONT-COLOR)]
