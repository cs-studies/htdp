...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Exercise-392) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;;
;; Exercise 392.
...
(define (tree-pick tree lod)
  (cond
    [(and (or (symbol? tree) (branch? tree)) (empty? lod)) tree]
